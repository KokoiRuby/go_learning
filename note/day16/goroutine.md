...
挂载 Go 主线程下拥有**独立的栈空间，共享堆空间，用户空间级别由 Go runtime 调度**。
...
`GOMAXPROCS` 决定运行时可并行的 Goroutine 的最大数量
...
![image-20240702155552423](./goroutine.assets/image-20240702155552423.png)
...
![image-20240702155638822](./goroutine.assets/image-20240702155638822.png)
